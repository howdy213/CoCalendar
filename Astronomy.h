...
namespace astronomy {
	...
	static REAL make_julian_day(int year, int month, int day, int hour, int minute, int second, REAL ms) {
		if (month <= 2) {
			month += 12;
			--year;
		}
		...
		return floor(a) + floor(b) + B + 1720996.5 + day + hour / 24.0 + minute / 1440.0 + ((double)second + ms / 1000.0) / 86400.0;
	}
	...
	static void daytime_from_julian_day(REAL jd, Time* p) {
